...
MULTISTART_FILES = {
    "Ns1": Path("results/5time_nonuniform_multistart/multistart_results.csv"),
    "Ns2": Path("results/5time_nonuniform_multistart_Ns2/multistart_results.csv"),
    "Ns3": Path("results/5time_nonuniform_multistart_Ns3/multistart_results.csv"),
    "Ns5": Path("results/5time_nonuniform_multistart_Ns5/multistart_results.csv"),
}

OUTPUT_PNG = Path("results/identifiability_summary.png")

OUTPUT_PDF = Path("results/identifiability_summary.pdf")
