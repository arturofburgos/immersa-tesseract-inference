...
OUTPUT_DIR = Path("results/5time_landscape")
...
def main() -> None:
    """Run the five-time AoA loss-landscape scan."""
    OUTPUT_DIR.mkdir(
        parents=True,
        exist_ok=True,
    )
    ...
    print("=" * 76, flush=True)
    print(
        "5-TIME NOISE-FREE AoA LOSS LANDSCAPE",
        flush=True,
    )
    print("=" * 76, flush=True)
    ...
    csv_path = OUTPUT_DIR / "loss_landscape_5times.csv"
