...
RESULTS_ROOT = Path(
    "results/wake_surrogate/dataset_validation"
)
...
def plot_test_case() -> None:
    ...
    output = (
        RESULTS_ROOT
        / "dataset_check_alpha63_t15p1.png"
    )
