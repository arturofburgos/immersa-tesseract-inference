...
MULTISTART_FILES = {
    "Ns1": Path(
        "results/identifiability/multistart/Ns1.csv"
    ),
    "Ns2": Path(
        "results/identifiability/multistart/Ns2.csv"
    ),
    "Ns3": Path(
        "results/identifiability/multistart/Ns3.csv"
    ),
    "Ns5": Path(
        "results/identifiability/multistart/Ns5.csv"
    ),
}
